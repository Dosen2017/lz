...
return [
    ...
    'Local addon'                                           => '本地插件',
    'Day_report tips'                                       => '成本:当日消耗金额<br/>注册:当日注册用户数<br/>单价:单个玩家成本',
    'Channel Tips'                                          => 'oCPA投放与用CPC投放有什么区别？<br/>如果您使用CPC投放，系统会面向受众中最可能点击广告链接的用户投放广告；<br/>如果您使用oCPA投放，系统会面向受众中最可能发生目标转化行为的用户投放广告，帮助您获得更多目标转化量，并尽可能使转化成本贴近您的出价',
];
