...
define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, ArtTemp) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'adstat/period_analy/index' + location.search,
                    add_url: 'adstat/period_analy/add',
                    edit_url: 'adstat/period_analy/edit',
                    del_url: 'adstat/period_analy/del',
                    multi_url: 'adstat/period_analy/multi',
                    table: 'game_users',
                }
            });
