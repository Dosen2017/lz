...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'adstat/retention_analy/index' + location.search,
                    add_url: 'adstat/retention_analy/add',
                    edit_url: 'adstat/retention_analy/edit',
                    del_url: 'adstat/retention_analy/del',
                    multi_url: 'adstat/retention_analy/multi',
                    table: 'game_users',
                }
            });
