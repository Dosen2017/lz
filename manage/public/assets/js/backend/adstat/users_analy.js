...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'adstat/users_analy/index' + location.search,
                    add_url: 'adstat/users_analy/add',
                    edit_url: 'adstat/users_analy/edit',
                    del_url: 'adstat/users_analy/del',
                    multi_url: 'adstat/users_analy/multi',
                    table: 'game_users',
                }
            });
