...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'adstat/pay_trend/index' + location.search,
                    add_url: 'adstat/pay_trend/add',
                    edit_url: 'adstat/pay_trend/edit',
                    del_url: 'adstat/pay_trend/del',
                    multi_url: 'adstat/pay_trend/multi',
                    table: 'game_users',
                }
            });
