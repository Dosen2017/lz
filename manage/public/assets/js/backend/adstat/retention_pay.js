...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'adstat/retention_pay/index' + location.search,
                    add_url: 'adstat/retention_pay/add',
                    edit_url: 'adstat/retention_pay/edit',
                    del_url: 'adstat/retention_pay/del',
                    multi_url: 'adstat/retention_pay/multi',
                    table: 'game_users',
                }
            });
