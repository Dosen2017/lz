...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'datastat/daily_keydata/index' + location.search,
                    add_url: 'datastat/daily_keydata/add',
                    edit_url: 'datastat/daily_keydata/edit',
                    del_url: 'datastat/daily_keydata/del',
                    multi_url: 'datastat/daily_keydata/multi',
                    table: 'game_users',
                }
            });
