...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'datastat/retention_analy/index' + location.search,
                    add_url: 'datastat/retention_analy/add',
                    edit_url: 'datastat/retention_analy/edit',
                    del_url: 'datastat/retention_analy/del',
                    multi_url: 'datastat/retention_analy/multi',
                    table: 'game_users',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 's_active90', title: __('S_active90'), operate:false},
                        {field: 's_active120', title: __('S_active120'), operate:false},
                        {field: 's_active180', title: __('S_active180'), operate:false},
                        {field: 's_active360', title: __('S_active360'), operate:false},
