...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'datastat/game_orders/index' + location.search,
                    add_url: 'datastat/game_orders/add',
                    edit_url: 'datastat/game_orders/edit',
                    del_url: 'datastat/game_orders/del',
                    multi_url: 'datastat/game_orders/multi',
                    table: 'game_orders',
                }
            });
            ...
            // $("select[name=game_num]").selectpicker('refresh');
            // $("select[name=game_num]").selectpicker('render');
            // $("select[name=channel_num]").selectpicker('refresh');
            // $("select[name=channel_num]").selectpicker('render');
            // $("select[name=channel_pkg_num]").selectpicker('refresh');
            // $("select[name=channel_pkg_num]").selectpicker('render');
