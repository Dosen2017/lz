...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'datastat/amount_analy/index' + location.search,
                    add_url: 'datastat/amount_analy/add',
                    edit_url: 'datastat/amount_analy/edit',
                    del_url: 'datastat/amount_analy/del',
                    multi_url: 'datastat/amount_analy/multi',
                    table: 'game_users',
                }
            });
